...
<!-- omit from toc -->
# Historical YOLOv5 reference

> This document describes the original, unmodified example, not the current code.
> Use [README.md](README.md) for the YOLOv8 OBB application, model requirements,
> package name, build instructions, and FastCGI endpoint.
